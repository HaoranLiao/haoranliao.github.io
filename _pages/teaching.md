...
their connections to classical Bayesian networks. Showed that adding noisy ancillas helps mitigate decoherence effect in simulations with distributed GPU training. (QMI 2022)
  ...
  * Derived the robustness of general quantum classifiers against worst-case input perturbations based on concentration
  of measure phenomenon in certain probabilistically-sampled metric spaces. Argued against the belief of extreme vulnerability in generic quantum classifiers and proved that their
