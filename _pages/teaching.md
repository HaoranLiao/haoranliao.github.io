...
<br> 02/2024&ndash;Present &nbsp;Los Angeles, United States
  * Devised a novel protocol for long-range CNOT gates that significantly outperforms the existing dynamic-circuit protocol, achieving the highest-fidelity CNOT gate teleportation across up to at least 40 lattice sites. Leveraged limited error detection schemes to enable 75Q GHZ state preparation, the largest reported to date. (Almost there)
