...
Quantum computing does not use digital logic and transistors. It operates under the rules of quantum mechanics and uses logic based on quantum state evolution and manipulation. It offers a huge speedup in solving certain important problems, though we are only at an early stage of building a general-purposed fault-tolerant quantum computer. My projects, papers and talks can be found through the navigation bar. Besides physics, I am also interested in machine learning, computer science and their interplays with physics.
