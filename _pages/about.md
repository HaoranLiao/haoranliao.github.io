...
Quantum computing does not use digital logic and transistors. Instead, it operates under the rules of quantum mechanics and uses logic based on quantum state evolution and manipulation, which offers a huge speedup in solving certain problems. My projects, papers and talks can be found through the navigation bar. Besides physics, I am also interested in machine learning, computer science and their interplays with physics.
