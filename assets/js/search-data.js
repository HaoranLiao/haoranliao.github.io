...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
          ...
          section: "Navigation",
          handler: () => {
            window.location.href = "/curriculum_vitae/";
          },
        ...
        handler: () => {
          ...
          section: "Projects",handler: () => {
            ...
            },},{id: "projects-quantum-adversarial-attack",
          title: 'Quantum Adversarial Attack',
          description: "Adversarial robustness of quantum machine learning",
          section: "Projects",handler: () => {
              window.location.href = "/projects/adversarial_presentation/";
            },},{id: "projects-fast-radio-bursts",
          title: 'Fast Radio Bursts',
          description: "Search for extragalactic signals with the CHIME telescope",
          section: "Projects",handler: () => {
              window.location.href = "/projects/chime_project/";
            },},{id: "projects-covid-19-forecast",
          title: 'COVID-19 Forecast',
          description: "DATA 200 graduate project  US weekly COVID-19 forecast with engineered features",
          section: "Projects",handler: () => {
          ...
          section: "Projects",handler: () => {
            ...
            },},{id: "projects-decohering-tensor-network-qml",
          title: 'Decohering Tensor Network QML',
          description: "Transforming QNNs to classical Bayesian networks",
          section: "Projects",handler: () => {
              window.location.href = "/projects/decohering_tn_qml/";
            },},{id: "projects-confined-diffusion",
        ...
        section: 'Socials',
        handler: () => {
          window.open("mailto:%68%61%6F%72%61%6E%6C%69%61%6F%32@%67%6D%61%69%6C.%63%6F%6D", "_blank");
        },
      },{
        id: 'social-github',
        title: 'GitHub',
        section: 'Socials',
        handler: () => {
          window.open("https://github.com/HaoranLiao", "_blank");
        },
      },{
        id: 'social-linkedin',
        title: 'LinkedIn',
        section: 'Socials',
        handler: () => {
          window.open("https://www.linkedin.com/in/haoran-liao", "_blank");
        },
      },{
        id: 'social-orcid',
        title: 'ORCID',
